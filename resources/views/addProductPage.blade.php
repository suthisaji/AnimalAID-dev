        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <form name="add_product" action="/add_product" class="form" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                {{ Form::token() }}
                ...
                <div class="form-group" id="product_pic">
                  <label for="product_pic" class="form-label">รูปภาพ</label><br>
                  <input type="file" name="product_pic" required/>
                </div>

                <div class="form-group">
                  <label for="category_id" class="form-label">ประเภทสินค้า</label> <br>
                  <select class="custom-select "  style="  border: 5px solid rgba(0, 255, 0,.15);" name="category_id" >@foreach($category as $ct)
                    <option value="{{$ct->category_id}}">
                      @if($ct->category_name=='เครื่องใช้ของสัตว์')
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="product_detail" row="2"></textarea>
                </div>
